// Code generated by protoc-gen-go-grpcimp. DO NOT EDIT.
// versions:
// - protoc-gen-go-grpcimp v1.3.0
// - protoc             v5.26.1
...
// is compatible with the grpcimp package it is being compiled against.
// Requires gRPC-Go v1.32.0 or later.
const _ = grpc.SupportPackageIsVersion7

const (
	Metrics_UpdateMetrics_FullMethodName = "/grpchandlers.Metrics/UpdateMetrics"
)
...
// Metrics_ServiceDesc is the grpcimp.ServiceDesc for Metrics service.
// It's only intended for direct use with grpcimp.RegisterService,
// and not to be introspected or modified (even as a copy)
var Metrics_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpchandlers.Metrics",
